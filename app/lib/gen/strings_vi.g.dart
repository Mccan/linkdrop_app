...
class _TranslationsReceiveOptionsPageVi extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(Thư mục LinkDrop)';
  @override
...
class _TranslationsWebSharePageVi extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LinkDrop dùng chứng chỉ tự tạo. Bạn cần chấp thuận trong trình duyệt.';
  @override
...
class _TranslationsAboutPageVi extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Thông tin về LinkDrop';
  @override
  List<String> get description => [
    'LinkDrop là một phần mềm miễn phí mã nguồn mở, giúp bạn chia sẻ tập tin cũng như tin nhắn đến các thiết bị phụ cận một cách bảo mật thông qua mạng nội bộ mà không cần kết nối mạng đến bên ngoài.',
...
class _TranslationsDonationPageVi extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LinkDrop là ứng dụng miễn phí, mã nguồn mở, không chứa quảng cáo. Nếu bạn yêu thích ứng dụng này, bạn có thể hỗ trợ việc phát triển bằng việc ủng hộ.';
  @override
...
class _TranslationsTrayVi extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Đóng LinkDrop';
  @override
...
class _TranslationsSettingsTabGeneralVi extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Hiển thị LinkDrop ở danh mục';
  @override
...
class _TranslationsSettingsTabOtherVi extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Hỗ trợ LinkDrop';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedVi extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LinkDrop không thể tìm kiếm thiết bị khác khi không được phép quét mạng nội bộ. Vui lòng trao quyền cho ứng dụng trong cài đặt.';
  @override
...
class _TranslationsDialogsSendModeHelpVi extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Người nhận chưa cài đặt LinkDrop có thể nhận tập tin bằng cách mở liên kết trong trình duyệt.';
}
