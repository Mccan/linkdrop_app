...
class _TranslationsReceiveOptionsPagePtBr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(pasta LinkDrop)';
  @override
...
class _TranslationsWebSharePagePtBr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LinkDrop utiliza um certificado autoassinado. Você precisa aceitá-lo no navegador.';
  @override
...
class _TranslationsAboutPagePtBr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Sobre LinkDrop';
  @override
  List<String> get description => [
    'LinkDrop é um aplicativo gratuito e de código aberto que permite compartilhar arquivos e mensagens de forma segura com dispositivos próximos através da sua rede local, sem a necessidade de uma conexão com a internet.',
...
class _TranslationsDonationPagePtBr extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LinkDrop é gratuito, de código aberto e sem nenhum anúncio. Se tu curte o app, então considere apoiar o desenvolvimento com uma doação.';
  @override
...
class _TranslationsTrayPtBr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Fechar LinkDrop';
  @override
...
class _TranslationsNetworkInterfacesPagePtBr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Por padrão, o LinkDrop utiliza todas as interfaces de rede disponíveis. Você pode excluir as redes indesejadas aqui. É necessário reiniciar o servidor para aplicar as alterações.';
  @override
...
class _TranslationsSettingsTabGeneralPtBr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Mostrar LinkDrop no menu de contexto';
  @override
...
class _TranslationsSettingsTabOtherPtBr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Suporte o LinkDrop';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedPtBr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'O LinkDrop não consegue encontrar outros dispositivos sem ter a permissão para escanear a rede local. Por favor, conceda esta permissão nas configurações.';
  @override
...
class _TranslationsDialogsSendModeHelpPtBr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Os destinatários que não têm o LinkDrop instalado podem baixar os arquivos selecionados abrindo o link fornecido no navegador.';
}
