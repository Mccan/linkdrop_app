...
class _TranslationsAboutPageEnIn extends TranslationsAboutPageEn {
  ...
  List<String> get description => [
    'LinkDrop is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class _TranslationsDonationPageEnIn extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'LinkDrop is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
  @override
