...
class _AddressInputDialogState extends State<AddressInputDialog> with Refena {
  ...
  Widget build(BuildContext context) {
    ...
    final aliasOverrides = ref.watch(deviceAliasOverridesProvider);
                  ...
                  children: [
                    ...
                    ...lastDevices
                        .mapIndexed((index, device) {
                          final overrideAlias = aliasOverrides[device.fingerprint]?.trim();
                          final displayAlias = (overrideAlias != null && overrideAlias.isNotEmpty) ? overrideAlias : device.alias;
                          final displayText = (displayAlias.isNotEmpty && device.ip != null && device.ip!.isNotEmpty)
                              ? '$displayAlias (${device.ip})'
                              : (device.ip ?? displayAlias);
                          return [
